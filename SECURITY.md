...
In `hybrid` mode, a model may explicitly keep soft semantic candidates and can
make an incorrect decision. Validated identifiers and barcode/vision findings
remain locked, and malformed or unavailable model output falls back to rules,
